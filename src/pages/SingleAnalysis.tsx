...
const preventionData: PreventionItem[] = [
  ...
  },
  {
    ...
    icon: <Soup style={{ width: '24px', height: '24px', color: '#f97316' }} />,
    tips: [
      '坚持晨练：如慢跑、太极拳等，增强心肺功能',
      '进行室内运动：如瑜伽、健身操，不受天气限制',
      '定期爬山：呼吸新鲜空气，增强免疫力'
    ],
    description: '适当的运动可以促进血液循环，增强身体的抵抗力，有效预防流感。运动要适度，避免过度劳累。'
  },

  {
    ...
    title: '生活习惯预防法',
    category: '生活起居',
    icon: <Home style={{ width: '24px', height: '24px', color: '#d97706' }} />,
    tips: [
      '保持充足睡眠：每晚保证7 - 8小时的睡眠时间',
      '注意个人卫生：勤洗手，避免用手触摸口鼻',
      '保持室内通风：每天开窗通风2 - 3次，每次30分钟左右'
    ],
    description: '良好的生活习惯是预防流感的基础，规律的作息和卫生习惯能减少病毒感染的机会。'
  },
  {
    id: 4,
    title: '中药预防法',
    ...
    tips: [
      '服用玉屏风散：黄芪、白术、防风按一定比例配伍，可增强免疫力',
      '饮用银翘解毒汤：金银花、连翘等中药组成，清热解毒',
      '使用藿香正气水：可预防暑湿型流感'
    ],
    description: '中药在预防流感方面有独特的优势，根据个人体质和季节特点选择合适的中药进行调理。'
  },
